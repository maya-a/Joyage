...
/* WEBPACK VAR INJECTION */(function($) {var btnSubmitIndex = document.querySelector(".create-trip");
...
function hideLoading() {
  var loader = document.getElementById("loading-buddy");
...
$("#match-button").click(function () {
  ...
  setTimeout(function () {
    window.location = $("#match-button > a").attr('href');
  }, 4500);
...
;
setTimeout(start, 1000); // import {TweenMax, Power2} from "gsap/TweenMax";
...
/******/ });
//# sourceMappingURL=loading_script-ead406f7dbf28ca3c0f0.js.map