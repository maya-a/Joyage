...
!(function webpackMissingModule() { var e = new Error("Cannot find module 'gsap/gsap-bonus/MorphSVGPlugin'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());



var loading = function loading() {
  gsap_TweenMax__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].set('#circlePath', {
    attr: {
  ...
  gsap_TweenMax__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].set('svg', {
    visibility: 'visible'
  });
  gsap_TweenMax__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].set([plane], {
    transformOrigin: '50% 50%'
  });
  var circleBezier = !(function webpackMissingModule() { var e = new Error("Cannot find module 'gsap/gsap-bonus/MorphSVGPlugin'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).pathDataToBezier(circlePath.getAttribute('d'), {
    offsetX: -19,
    offsetY: -18
  });
  ...
  function makeDots() {
    ...
    for (var i = 0; i < numDots; i++) {
      ...
      angle = step * i;
      gsap_TweenMax__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].set(d, {
        attr: {
      ...
      tl.from(d, 0.2, {
        ...
        ease: gsap_TweenMax__WEBPACK_IMPORTED_MODULE_0__["Power2"].easeIn
      }).to(d, 1.8, {
        attr: {
          r: dotMin
        },
        ease: gsap_TweenMax__WEBPACK_IMPORTED_MODULE_0__["Power2"].easeOut
      });
  ...
  makeDots();
  mainTl.time(20);
  gsap_TweenMax__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].to(mainContainer, 30, {
    rotation: -360,
    svgOrigin: '400 300',
    repeat: -1,
    ease: Linear.easeNone
...
/******/ });
//# sourceMappingURL=loading_script-d7fc0f2e57f279e65165.js.map