...
const redirectPage = () => {
  ...
  bookButtons.forEach((button) => {
    button.addEventListener("click", (event) => {
      ...
      window.open(`https://www.skyscanner.co.il/transport/flights/${returnCode}/${destinationCode}/${departureDate}/${returnDate}/#results`);
    });
  });
}
...
https://www.skyscanner.co.il/transport/flights/cdg/ams/190713/190720/#results
